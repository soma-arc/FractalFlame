    ...
    data: function () {
        return {
            variations: [{id: 0, name:'Linear', v:0, params:[]},
                         ...
                         {id: 43, name:'Square', v:0, params:[]},
                         {id: 44, name:'Rays', v:0, params:[]},
                         {id: 45, name:'Blade', v:0, params:[]},
                         {id: 46, name:'Secant', v:0, params:[]},
                         {id: 47, name:'Twintrian', v:0, params:[]},
                         {id: 48, name:'Cross', v:0, params:[]},
                         {id: 49, name:'Loxodromic', v:0, params:[]},
                         {id: 50, name:'Loxodromic2', v:0, params:[]},
                         {id: 51, name:'LoxoScale', v:0, params:[]},
                         {id: 52, name:'LoxoScale2', v:0, params:[]},
                         {id: 53, name:'LoxoSwirlA', v:0, params:[]},
                         {id: 54, name:'LoxoSwirlB', v:0, params:[]},
                         {id: 55, name:'LoxoTangentA', v:0, params:[]},
                         {id: 56, name:'LoxoTangentB', v:0, params:[]},
                        ]
        }
    },
    methods: {
